...
let fullNames = [];
runners.forEach(theRunner => fullNames.push(`${theRunner.first_name} ${theRunner.last_name}`));
...
ticketPriceTotal = runners.reduce((ticketTotal, runner) => ticketTotal + runner.donation, 0)
